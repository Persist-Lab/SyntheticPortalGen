...
# Based on dp-transformers GitHub implementation https://github.com/microsoft/dp-transformers/tree/main/examples/nlg-reddit/sample-level-dp
...
def main(args: Arguments):
    ...
    df['patient_message'] = 'Patient Message: ' + df['patient_message'] ### Add prompt for generation. 
